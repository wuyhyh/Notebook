...
![img_2.png](pcie_pic/transaction_types.png)

### 2.1.1 PCIe transaction protocol 事务层协议

![img_2.png](pcie_pic/TLP_types.png)
...
![img_2.png](pcie_pic/pcie_device_layer.png)
...
![img_2.png](pcie_pic/pcie_dev_layers.png)
...
![img_2.png](pcie_pic/pcie_dl.png)
...
![img_2.png](pcie_pic/TLP_at_pl.png)

## 2.3 Non-posted memory read transaction 例子

![img_2.png](pcie_pic/mem_read_phase.png)
![img.png](pcie_pic/figure.2-32.png)
