...
我们是不可能在短时间内，提交有影响力的内核补丁，并且合并到主线的。那么我们能做到的：

- 阅读系统编程的知识，完成几个小的作品，巩固学习到操作系统知识，熟悉调试工具。
- 熟练解决高频的leetcode算法题，数据结构和算法的基本功我们是可以通过练习提高的。
- 做好基础知识的储备，C语言特性，操作系统概念,Linux内核概念，调试方法，如果没有时间实践，那就看看别人是怎么做的。
- 认真修改简历，完善项目，掌握面试技巧，自己与自己进行模拟面试。

一定要保持自信，你一定可以达到目标。

当你坦然看待你最不愿意看到的结果时，当你毫不畏惧那种最坏的后果时，你的勇气和精神力量会帮助你战胜困难，避免最坏后果的出现。
即使出现最坏的结果，你获得的价值也远远大于你的损失和付出。
...
今天，2025/3/6，我发现我可以开始写简历了。《ARM64体系结构编程与实践》这本书非常好。
