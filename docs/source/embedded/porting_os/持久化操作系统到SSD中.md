...
ext4load nvme 0:2 ${kernel_addr_r} /boot/Image-5.10.0-Dec-24th; \
ext4load nvme 0:2 ${fdt_addr_r}   /boot/pd2008-devboard-dsk.dtb; \
setenv bootargs "${console} root=/dev/nvme0n1p2 rw rootwait earlycon ignore_loglevel loglevel=8 audit=0 init=/usr/lib/systemd/systemd" \
...
```text
scp -P 2223 wuyuhang@192.168.11.100:~/music/baseline/nvme_images/* ./
```
