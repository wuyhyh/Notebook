...
```text
tftpboot $kernel_addr_r Image;tftpboot $ramdisk_addr_r openeuler-image-live-phytium-20251021070018.rootfs.cpio.gz;setexpr rdsize $filesize;tftpboot $fdt_addr_r pd2008-devboard-dsk.dtb
```
...
```text
tftpboot 0x90400000 Image;tftpboot 0x90000000 pd2008.dtb
```
